...
plot 'target/switching_point_rs.csv' using 2:3 ls 1 with points title 'Switching point position', \
'target/switching_point_rs.csv' using 2:3:(sprintf('%f', $2)) with labels center offset 0,0.5, \
