...
plot 'target/integ_fwd_end_step_rs.csv' using 2:3 ls 1 with linespoints title 'Last point point position', \
'target/integ_fwd_end_step_rs.csv' using 2:3:(sprintf('%f: %f', $2, $3)) with labels center offset 0,0.5, \
