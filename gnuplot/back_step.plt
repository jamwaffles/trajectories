...
'target/back_step_cpp.csv' using 2:4 ls 2 with dots title 'Acceleration', \
'target/back_step_cpp.csv' using 2:5 ls 3 with dots title 'Slope'
...
'target/back_step_rs.csv' using 2:4 ls 2 with dots title 'Acceleration', \
'target/back_step_rs.csv' using 2:5 ls 3 with dots title 'Slope'
