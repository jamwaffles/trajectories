...
plot 'target/plot_native.csv' using 1:2 with lines title 'Position X', 'target/plot_native.csv' using 1:3 with lines title 'Position Y', 'target/plot_native.csv' using 1:4 with lines title 'Position Z' , 'target/plot_native.csv' using 1:5 with lines title 'Accel X', 'target/plot_native.csv' using 1:6 with lines title 'Accel Y', 'target/plot_native.csv' using 1:7 with lines title 'Accel Z'